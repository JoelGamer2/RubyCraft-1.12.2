...
public class ChunkGeneratorRuby implements IChunkGenerator
{
  ...
  // private final WorldGenerator magmaGen = new WorldGenMinable(Bloques.bloque_de_ruby.getDefaultState(), 33, BlockMatcher.forBlock(Bloques.Ladrillo_Marino));
    ...
    */
    ...
    public ChunkGeneratorRuby(World world, boolean generate, long seed)
    {
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(IniciarBiomas.RubyBioma);
        }
