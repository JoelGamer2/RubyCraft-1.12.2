...
public class Referencia {
	...
	public static enum RubyCraftBloques{
        ...
        BLOQUE_REFORZADO_TIER_II("bloque_reforzado_tier_2","bloque_reforzado_tier_2"),
		BLOQUE_REFORZADO_TIER_III("bloque_reforzado_tier_3","bloque_reforzado_tier_3"),
		BLOQUE_REFORZADO_TIER_IV("bloque_reforzado_tier_4","bloque_reforzado_tier_4"),
		BLOQUE_REFORZADO_TIER_V("bloque_reforzado_tier_5","bloque_reforzado_tier_5"),
