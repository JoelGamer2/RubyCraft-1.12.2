...
public class OreGenDimensiones implements IWorldGenerator {
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator,
		...
		//End
		case 1:
			runGenerator(Bloques.mena_de_ruby_end.getDefaultState(), 5, 6, 1, 101, BlockMatcher.forBlock(Blocks.END_STONE), world, random, chunkX, chunkZ);
