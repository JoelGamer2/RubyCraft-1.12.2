package RubyCraft.Gui.Container.RecipeSorter;
...
public class ShapedRecipeZafiro extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements net.minecraftforge.common.crafting.IShapedRecipe
{
    ...
    public ShapedRecipeZafiro(String group, int width, int height, NonNullList<Ingredient> ingredients, ItemStack result)
    {
        this.group = group;
    ...
    public static ShapedRecipeZafiro deserialize(JsonObject p_193362_0_)
    {
        ...
        return new ShapedRecipeZafiro(s, i, j, nonnulllist, itemstack);
    }
